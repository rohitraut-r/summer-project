...
const Single = (props) => {
  ...
  const docRef = doc(db, "donors", dataId.id);
  //   useEffect(()=> {
  //     const Fetch = async() =>{
  ...
  const handleEdit = async () => {
    try {
      navigate("/donors/update_donors", { state: { ids } });
    } catch (err) {
      console.log(err);
    }
  };
          ...
          <div className="left">
            ...
            <div className="item">
              ...
              <div className="details">
                ...
                <div className="detailItem">
                  <span className="itemKey">Donation Amount: Rs.</span>
                  <span className="itemValue">{singleData.amount}</span>
                </div>
                <div className="detailItem">
