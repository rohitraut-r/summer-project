...
const PDFFiles = ({data}) => {
  ...
  <Page style={styles.page}>
    <Text style={styles.title}>All Children Information</Text>
    <View style={styles.table}>
      {/* Table Header */}
      <View style={styles.tableRow}>
        ...
        <Text style={styles.tableHeaderCell}>Guardian Phone</Text>
        <Text style={styles.tableHeaderCell}>Guardian</Text>
      </View>
      ...
      {data.map((row, index) => (
        <View style={styles.tableRow} key={index}>
          ...
          <Text style={styles.tableCell}>{row.guardian_phone}</Text>
          <Text style={styles.tableCell}>{row.guardian}</Text>
        </View>
      ))}
    </View>
  </Page>
